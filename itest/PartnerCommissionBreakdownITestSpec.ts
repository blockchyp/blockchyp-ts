...
import { PartnerCommissionBreakdownRequest } from '../index';
import { PartnerCommissionBreakdownResponse } from '../index';
  ...
  it('can retrieve partner commission breakdowns', function (done) {
    ...
    setTimeout(async function () {
      try {
        ...
        const request = new PartnerCommissionBreakdownRequest();
        request.test = true;

        const httpResponse = await client.partnerCommissionBreakdown(request)
        const response: PartnerCommissionBreakdownResponse = httpResponse.data;
        // response assertions
